#Memodifikasi RC4 dengan memodifikasi prosedur KSA atau PRGA di dalam RC4 dan mengabungkannya dengan konsep Extended Vigenere Cipher
from tkinter import *
...
#fungsi prga untuk membangkitkan keystream, dimodif dengan konsep extended vigenere cipher
def prga(s, text):
    i = 0
    j = 0
    keystream = []
